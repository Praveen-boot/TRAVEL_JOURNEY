...
function reportValue(key, value) {
  ...
  const reportFlagValue = _optionalChain([ctx, 'optionalAccess', _24 => _24.flags, 'optionalAccess', _25 => _25.reportValue]);
...
function internalReportValue(key, value, data) {
  const symbol = /* @__PURE__ */ Symbol.for("@vercel/request-context");
  const ctx = _optionalChain([Reflect, 'access', _26 => _26.get, 'call', _27 => _27(globalThis, symbol), 'optionalAccess', _28 => _28.get, 'call', _29 => _29()]);
  const reportFlagValue = _optionalChain([ctx, 'optionalAccess', _30 => _30.flags, 'optionalAccess', _31 => _31.reportValue]);
  if (typeof reportFlagValue !== "function") return;
  reportFlagValue.call(ctx.flags, key, value, {
    sdkVersion: version,
    ...data
...
var vercelFlagsTraceSymbol = /* @__PURE__ */ Symbol.for("flags:global-trace");
...
function getTracer() {
  ...
  return _optionalChain([maybeTraceApi, 'optionalAccess', _32 => _32.getTracer, 'call', _33 => _33(name, version)]);
}
...
function setSpanAttribute(name2, value) {
  _optionalChain([spanContext, 'access', _34 => _34.getStore, 'call', _35 => _35(), 'optionalAccess', _36 => _36.set, 'call', _37 => _37(name2, value)]);
}
        ...
        try {
          ...
          if (isPromise(result)) {
            result.then((value) => {
              ...
              _optionalChain([spanContext, 'access', _38 => _38.getStore, 'call', _39 => _39(), 'optionalAccess', _40 => _40.forEach, 'call', _41 => _41((value2, key) => {
              ...
              _optionalChain([spanContext, 'access', _42 => _42.getStore, 'call', _43 => _43(), 'optionalAccess', _44 => _44.forEach, 'call', _45 => _45((value, key) => {
            ...
            _optionalChain([spanContext, 'access', _46 => _46.getStore, 'call', _47 => _47(), 'optionalAccess', _48 => _48.forEach, 'call', _49 => _49((value, key) => {
              span.setAttribute(key, value);
            })]);
            span.setStatus({ code: 1 });
            span.end();
          ...
          _optionalChain([spanContext, 'access', _50 => _50.getStore, 'call', _51 => _51(), 'optionalAccess', _52 => _52.forEach, 'call', _53 => _53((value, key) => {
            span.setAttribute(key, value);
          })]);
          span.end();
          throw error;
...
var verifyAccess = trace(
  async function verifyAccess2(authHeader, secret = _optionalChain([process, 'optionalAccess', _54 => _54.env, 'optionalAccess', _55 => _55.FLAGS_SECRET])) {
...
//# sourceMappingURL=chunk-ZFCSUOES.cjs.map